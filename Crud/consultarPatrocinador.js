...
function userCreate(url_imagem, email, web, celular, nome) {
   ...
   //alert()
    const xhttp = new XMLHttpRequest();
    xhttp.open("POST", "https://api-four-line.azurewebsites.net/api/Patrocinador/");
...
function userDelete(id) {
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.isConfirmed) {
      const xhttp = new XMLHttpRequest();
      xhttp.open("DELETE", "https://api-four-line.azurewebsites.net/api/Patrocinador/"+id);
      xhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
      xhttp.send(JSON.stringify({ 
        "id": id
      }));
...
function userEdit(url_imagem, nome, website, email, celular, idPat) {
  ...
  const xhttp = new XMLHttpRequest();
  xhttp.open("PUT", "https://api-four-line.azurewebsites.net/api/Patrocinador/");
  xhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
  xhttp.send(JSON.stringify({
