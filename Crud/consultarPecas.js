function loadTable() {
  ...
  xhttp.open("GET", "https://api-four-line.azurewebsites.net/api/Ficha/"); //ajustar para receber a lista de fichas (AJUSTAR NOME DE PARAMETROS )
  xhttp.send();
...
function buscarNomeTema(id) {
  console.log(id);
  const xhttp = new XMLHttpRequest();
  xhttp.open("GET", "https://api-four-line.azurewebsites.net/api/Tema/" + id);
  xhttp.send();
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      const objects = JSON.parse(this.responseText);
...
function showUserCreateBox() {
  Swal.fire({
    ...
    didOpen: () => {
      const xhttp = new XMLHttpRequest();
      xhttp.open("GET", "https://api-four-line.azurewebsites.net/api/Tema/"); //url de get tema
      xhttp.send();
      xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function userCreate(url_imagem, nomeimg, idTema) {
  ...
  const xhttp = new XMLHttpRequest();
  xhttp.open("POST", "https://api-four-line.azurewebsites.net/api/Ficha/");  //url de post ficha
...
function userDelete(id) {
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.isConfirmed) {
      const xhttp = new XMLHttpRequest();
      xhttp.open("DELETE", "https://api-four-line.azurewebsites.net/api/Ficha/" + id); //url delete peca (Id no json)
      xhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
      xhttp.send(JSON.stringify({
        "id": id
      }));
...
function showUserEditBox(id) {
  console.log(id);
  const xhttp = new XMLHttpRequest();
  xhttp.open("GET", "https://api-four-line.azurewebsites.net/api/Ficha/" + id); //url de get Ficha especifica através de Id
  xhttp.send();
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      Swal.fire({
        ...
        didOpen: () => {
          const xhttp = new XMLHttpRequest();
          xhttp.open("GET", "https://api-four-line.azurewebsites.net/api/Tema/"); //url get tema
          xhttp.send();
          xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
              console.log(this.responseText);
...
function userEdit(url_imagem, NomeFicha, Tema, idFicha) {
  ...
  const xhttp = new XMLHttpRequest();
  xhttp.open("PUT", "https://api-four-line.azurewebsites.net/api/Ficha/");    //url de update fichas
  xhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
  xhttp.send(JSON.stringify({
