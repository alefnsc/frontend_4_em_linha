function loadTable() {
  ...
  xhttp.open("GET", "https://api-four-line.azurewebsites.net/api/Tema/");
  xhttp.send();
...
function buscarNomePatrocinador(id) {
  //console.log(id);
  const xhttp = new XMLHttpRequest();
  xhttp.open("GET", "https://api-four-line.azurewebsites.net/api/Patrocinador/" + id);
  xhttp.send();
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      const objects = JSON.parse(this.responseText);
...
function userCreate(url_imagem, nomeImagem, idPatrocinador) {
  ...
  const xhttp = new XMLHttpRequest();
  xhttp.open("POST", "https://api-four-line.azurewebsites.net/api/Tema");
...
function userDelete(id) {
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.isConfirmed) {
      const xhttp = new XMLHttpRequest();
      xhttp.open("DELETE", "https://api-four-line.azurewebsites.net/api/Tema/" + id);
      xhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
      xhttp.send(JSON.stringify({
        "id": id
      }));
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      Swal.fire({
        ...
        didOpen: () => {
          const xhttp = new XMLHttpRequest();
          xhttp.open("GET", "https://api-four-line.azurewebsites.net/api/Patrocinador/"); //url get Patrocinadores
          xhttp.send();
          xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
              //console.log(this.responseText);
...
function userEdit(url_imagem, nome, idpat, idtema) {
  ...
  const xhttp = new XMLHttpRequest();
  xhttp.open("PUT", "https://api-four-line.azurewebsites.net/api/Tema/");
  xhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
  xhttp.send(JSON.stringify({
